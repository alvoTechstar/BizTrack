...
const CreateAdmin = ({ businessData, onNext, onBack }) => {
  ...
  const formIsValid = () => {
    ...
    if (!validatePhoneNumber(formData.phoneNumber.replace(/\D/g, ""))) return false;
    if (formData.email.trim() && !validateEmail(formData.email)) return false;
    if (formData.password.trim() && !validatePassword(null, formData.password)) return false;
    return true;
  };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <Paper elevation={3} className="p-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Create Admin User</h1>
          <Paper elevation={1} className="p-4 mb-6 bg-gray-50">
            ...
            <div className="flex items-center gap-4">
              <Avatar
                ...
                alt="Business Logo"
                size="large"
                style={{ backgroundColor: businessData?.primaryColor || "#e5e7eb" }}
              />
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      ...
                      style={{ backgroundColor: businessData?.primaryColor || "#000000" }}
                    ></div>
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <TextInput
              ...
              helperText={!errors.phoneNumber ? "Kenya format: +254XXXXXXXXX" : undefined}
              required
